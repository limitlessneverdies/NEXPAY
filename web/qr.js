/* Vendored QRCode (c) 2009 Kazuhiko Arase, MIT; node adaptations from qrcode-terminal. See THIRD_PARTY_NOTICES.md. */
...
}};const cache={};function req(name){name=name.replace(/^\.\//, "");if(!cache[name]){const m={exports:{}};cache[name]=m;modules[name](m,m.exports,req)}return cache[name].exports}window.PailaQR={Code:req("index"),Level:req("QRErrorCorrectLevel")};})();
